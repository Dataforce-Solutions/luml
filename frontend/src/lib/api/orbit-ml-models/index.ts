...
export class MlModelsApi {
  ...
  async createModel(organizationId: string, orbitId: string, collectionId: string, data: MlModelCreator) {
  ...
  async updateModel(organizationId: string, orbitId: string, collectionId: string, modelId: string, data: UpdateMlModelPayload) {
  ...
  async getModelDownloadUrl(organizationId: string, orbitId: string, collectionId: string, modelId: string) {
  ...
  async getModelDeleteUrl(organizationId: string, orbitId: string, collectionId: string, modelId: string) {
  ...
  async confirmModelDelete(organizationId: string, orbitId: string, collectionId: string, modelId: string) {
