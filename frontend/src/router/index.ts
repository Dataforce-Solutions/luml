      ...
      children: [
        {
          path: '',
          name: 'collection',
          component: () => import('../pages/collection/ArtifactsListView.vue'),
        },
        {
          path: 'artifacts/:artifactId',
          component: () => import('../pages/collection/artifact/index.vue'),
          children: [
            {
              path: '',
              name: 'artifact',
            ...
            },
            {
              ...
              component: () => import('../pages/collection/artifact/SnapshotView.vue'),
            },
            {
              path: 'attachments',
              name: 'attachments',
        ...
        },
        {
          path: 'compare',
          name: 'compare',
          component: () => import('../pages/collection/compare/CompareView.vue'),
        },
      ],
    },
    {
